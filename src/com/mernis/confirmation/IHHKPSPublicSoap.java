...
public class IHHKPSPublicSoap
{
    ...
    public IHHKPSPublicSoap(){}

    public IHHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IHHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IHHExtendedSoapSerializationEnvelope envelope= new IHHExtendedSoapSerializationEnvelope(IHHExtendedSoapSerializationEnvelope.VER11);
