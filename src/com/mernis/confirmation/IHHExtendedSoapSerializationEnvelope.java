...
public class IHHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IHHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IHHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IHHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IHHDateTimeConverter dateTimeConverter = new IHHStandardDateTimeConverter();

    public IHHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IHHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IHHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IHHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IHHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IHHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
